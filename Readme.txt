...
New feature: can preview the output image and control its color accuracy, improved color rendering, can manually recover if the position anchor (barcodes) is vandalized, enables ink-saving mode.
